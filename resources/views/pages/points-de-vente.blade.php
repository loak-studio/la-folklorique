<x-main-layout title="Points de vente" :breadcrumb="[['name' => 'Points de vente', 'route' => 'points-de-vente']]">
    ...
    <ul class="hidden">
        ...
        <li data-name="{{ $shop->name }}" data-latitude="{{ $shop->latitude }}" data-longitude="{{ $shop->longitude }}" data-street="{{ $shop->street }}" data-city="{{ $shop->city }}" data-google_my_business="{{ $shop->google_my_business }}">
