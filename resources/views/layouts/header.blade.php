...
<header
    ...
    <div data-mobile-navigation
        class="absolute flex z-[80] h-screen w-screen top-0  lg:top-auto lg:w-auto lg:h-auto self-center mx-auto transition -translate-x-[1000px] lg:block lg:translate-x-0 justify-self-center">
