...
<div data-animation-specification-root
    ...
    <img data-animation-specification="image" class="absolute left-0 hidden max-w-3xl rounded-md lg:flex"
        src="assets/caracteristiques.webp" alt="">
    ...
    <div data-animation-specification="text"
        ...
        <img data-animation-specification="bottle"
        ...
        <div class="z-20">
            <x-button href="{{ route('boutique') }}" class="max-w-fit">Découvrir</x-button>
        </div>
